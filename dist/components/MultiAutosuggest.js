...
var _excluded = ["value", "options", "label", "name", "placeholder", "handleChange", "handleInputChange"];
...
var MultiAutosuggest = function MultiAutosuggest(_ref) {
  ...
  }, label), defaultValue && /*#__PURE__*/_react["default"].createElement(_Autocomplete["default"], {
    multiple: true,
    classes: {
